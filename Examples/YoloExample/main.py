...
train_generator = DataGenerator(trainrecord, labelfile, image_dims=[448,448,3], output_dims=[7,7,output_len], num_classes=num_classes, nb_boxes=nb_boxes, batch_size=batch_size)
eval_generator = DataGenerator(evalrecord, labelfile, image_dims=[448,448,3], output_dims=[7,7,output_len], num_classes=num_classes, nb_boxes=nb_boxes, batch_size=batch_size)
